  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-6 font-sans">
      <div className="flex justify-between items-center text-sm text-gray-600 dark:text-gray-400 mb-4">
        ...
        <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Print</a>
      </div>
      <h1 className="text-2xl font-bold mb-6 text-gray-800 dark:text-gray-100">Mortgage Calculator</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-9 space-y-12">
          ...
          <div className="bg-blue-600 text-white p-3 rounded-t-md flex items-center justify-between cursor-pointer">
            <span className="font-semibold">Modify the values and click the Calculate button to use</span>
            <span className="text-xl">▼</span>
          </div>
          
          <div className="bg-white dark:bg-gray-800 p-6 border border-gray-200 dark:border-gray-700 rounded-b-md shadow-sm space-y-4">
            
            <div className="flex items-center justify-between">
              <label className="text-sm text-gray-700 dark:text-gray-300 font-medium">Home Price</label>
              <div className="relative w-40">
                ...
                <input 
                  ...
                  className="w-full pl-6 pr-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded text-right bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 outline-none"
                />
              </div>
            </div>

            <div className="flex items-center justify-between">
              <label className="text-sm text-gray-700 dark:text-gray-300 font-medium flex items-center gap-1">
              ...
              <div className="flex gap-2 w-40">
                <div className="relative w-1/3">
                  <input 
                    ...
                    className="w-full pr-4 py-1.5 border border-gray-300 dark:border-gray-600 rounded text-right bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 outline-none"
                  />
                ...
                <div className="relative w-2/3">
                  ...
                  <input 
                    ...
                    className="w-full pl-5 pr-2 py-1.5 border border-gray-300 dark:border-gray-600 rounded text-right bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 outline-none"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              <label className="text-sm text-gray-700 dark:text-gray-300 font-medium">Loan Term</label>
              <div className="relative w-40">
                <input 
                  type="number" 
                  value={loanTerm}
                  onChange={(e) => setLoanTerm(e.target.value)}
                  className="w-full pr-12 py-1.5 border border-gray-300 dark:border-gray-600 rounded text-right bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 outline-none"
                />
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="relative w-40">
                <input 
                  ...
                  className="w-full pr-6 py-1.5 border border-gray-300 dark:border-gray-600 rounded text-right bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 outline-none"
                />
            ...
            <div className="flex items-center justify-between">
              <label className="text-sm text-gray-700 dark:text-gray-300 font-medium">Start Date</label>
              <div className="flex gap-2 w-40">
                <select 
                  value={startMonth}
                  onChange={(e) => setStartMonth(e.target.value)}
                  className="w-1/2 py-1.5 px-2 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 outline-none text-sm"
                >
            ...
            <div className="pt-4 border-t border-gray-200 dark:border-gray-700 mt-4">
              <label className="flex items-center gap-2 mb-4 cursor-pointer">
                ...
                />
                <span className="text-sm font-bold text-gray-800 dark:text-gray-200">Include Taxes & Costs Below</span>
              </label>

              <div className="text-right text-xs text-gray-500 mb-2">Annual Tax & Cost</div>
                  ...
                  <div className="flex gap-2 w-40">
                    <div className="relative w-1/3">
                      <input 
                        ...
                        className="w-full pr-4 py-1 border border-gray-300 dark:border-gray-600 rounded text-right bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 disabled:opacity-50 focus:ring-2 focus:ring-blue-500 outline-none text-sm"
                      />
                      <span className="absolute right-1 top-1/2 -translate-y-1/2 text-gray-500 text-xs">%</span>
                    </div>
                    <div className="relative w-2/3">
                      <span className="absolute left-2 top-1/2 -translate-y-1/2 text-gray-500 text-xs">$</span>
                      <input 
                        ...
                        disabled={!includeTaxes}
                        className="w-full pl-5 pr-2 py-1 border border-gray-300 dark:border-gray-600 rounded text-right bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 disabled:opacity-50 focus:ring-2 focus:ring-blue-500 outline-none text-sm"
                      />
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-4 text-center">
                <button className="text-blue-600 dark:text-blue-400 text-sm hover:underline">+ More Options</button>
              </div>
        ...
        <div className="md:col-span-7 space-y-6">
            ...
            <div className="p-4">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-gray-700">
                    <th className="text-left py-2 font-semibold text-gray-700 dark:text-gray-300"></th>
                    <th className="text-right py-2 font-semibold text-gray-700 dark:text-gray-300">Monthly</th>
                    <th className="text-right py-2 font-semibold text-gray-700 dark:text-gray-300">Total</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                  <tr>
                    <td className="py-2 font-bold text-gray-900 dark:text-gray-100">Mortgage Payment</td>
                    <td className="text-right py-2 font-bold text-gray-900 dark:text-gray-100">{formatCurrencyDecimals(results.principalAndInterest)}</td>
                    <td className="text-right py-2 font-bold text-gray-900 dark:text-gray-100">{formatCurrencyDecimals(results.principalAndInterest * parseFloat(loanTerm) * 12)}</td>
                  </tr>
                  {includeTaxes && (
                    <>
                      <tr>
                        <td className="py-2 text-gray-600 dark:text-gray-400">Property Tax</td>
                        <td className="text-right py-2 text-gray-600 dark:text-gray-400">{formatCurrencyDecimals(results.propertyTax)}</td>
                        <td className="text-right py-2 text-gray-600 dark:text-gray-400">{formatCurrencyDecimals(results.propertyTax * parseFloat(loanTerm) * 12)}</td>
                      </tr>
                      <tr>
                        <td className="py-2 text-gray-600 dark:text-gray-400">Home Insurance</td>
                        <td className="text-right py-2 text-gray-600 dark:text-gray-400">{formatCurrencyDecimals(results.homeInsurance)}</td>
                        <td className="text-right py-2 text-gray-600 dark:text-gray-400">{formatCurrencyDecimals(results.homeInsurance * parseFloat(loanTerm) * 12)}</td>
                      </tr>
                      <tr>
                        <td className="py-2 text-gray-600 dark:text-gray-400">Other Costs</td>
                        <td className="text-right py-2 text-gray-600 dark:text-gray-400">{formatCurrencyDecimals(results.other)}</td>
                        <td className="text-right py-2 text-gray-600 dark:text-gray-400">{formatCurrencyDecimals(results.other * parseFloat(loanTerm) * 12)}</td>
                      </tr>
                    </>
                  )}
                  <tr className="bg-gray-50 dark:bg-gray-800/50">
                    <td className="py-2 font-bold text-gray-900 dark:text-gray-100">Total Out-of-Pocket</td>
                    <td className="text-right py-2 font-bold text-gray-900 dark:text-gray-100">{formatCurrencyDecimals(results.total)}</td>
                    <td className="text-right py-2 font-bold text-gray-900 dark:text-gray-100">{formatCurrencyDecimals(results.totalPayments)}</td>
                  </tr>
                </tbody>
              </table>
              ...
              <div className="mt-6 flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center gap-2"><div className="w-3 h-3 bg-blue-500"></div> <span className="text-gray-700 dark:text-gray-300">Principal & Interest</span></div>
                  {includeTaxes && <div className="flex items-center gap-2"><div className="w-3 h-3 bg-emerald-500"></div> <span className="text-gray-700 dark:text-gray-300">Property Taxes</span></div>}
                  {includeTaxes && <div className="flex items-center gap-2"><div className="w-3 h-3 bg-amber-500"></div> <span className="text-gray-700 dark:text-gray-300">Home Insurance</span></div>}
                  {includeTaxes && <div className="flex items-center gap-2"><div className="w-3 h-3 bg-indigo-500"></div> <span className="text-gray-700 dark:text-gray-300">Other Cost</span></div>}
                </div>
              </div>

              <div className="mt-8 space-y-2 text-sm">
                <div className="flex justify-between py-1 border-b border-gray-100 dark:border-gray-800">
                  <span className="font-bold text-gray-900 dark:text-gray-100">House Price</span>
                  <span className="text-gray-700 dark:text-gray-300">{formatCurrency(parseFloat(homePrice))}</span>
                </div>
                <div className="flex justify-between py-1 border-b border-gray-100 dark:border-gray-800">
                  <span className="text-gray-700 dark:text-gray-300">Loan Amount</span>
                  <span className="text-gray-700 dark:text-gray-300">{formatCurrency(results.loanAmount)}</span>
                </div>
                <div className="flex justify-between py-1 border-b border-gray-100 dark:border-gray-800">
                  <span className="text-gray-700 dark:text-gray-300">Down Payment</span>
                  <span className="text-gray-700 dark:text-gray-300">{formatCurrency(parseFloat(downPaymentAmount))}</span>
                </div>
                <div className="flex justify-between py-1 border-b border-gray-100 dark:border-gray-800">
                  <span className="text-gray-700 dark:text-gray-300">Total of {parseFloat(loanTerm) * 12} Mortgage Payments</span>
                  <span className="text-gray-700 dark:text-gray-300">{formatCurrency(results.principalAndInterest * parseFloat(loanTerm) * 12)}</span>
                </div>
                <div className="flex justify-between py-1 border-b border-gray-100 dark:border-gray-800">
                  <span className="text-gray-700 dark:text-gray-300">Total Interest</span>
                  <span className="text-gray-700 dark:text-gray-300">{formatCurrency(results.totalInterest)}</span>
                </div>
                <div className="flex justify-between py-1">
                  <span className="text-gray-700 dark:text-gray-300">Mortgage Payoff Date</span>
                  <span className="text-gray-700 dark:text-gray-300">{startMonth} {parseInt(startYear) + parseInt(loanTerm)}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center text-sm">
            <div className="mb-2">
              <span className="font-bold text-gray-800 dark:text-gray-200">Latest Mortgage Rates:</span>{' '}
              <span className="text-gray-600 dark:text-gray-400">30 Years: <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">6.47%</a></span>{' '}
              <span className="text-gray-600 dark:text-gray-400">15 Years: <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">5.587%</a></span>{' '}
              <span className="text-gray-600 dark:text-gray-400">10 Years: <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">5.447%</a></span>
            </div>
            <div className="flex justify-center gap-2">
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-1.5 rounded text-sm font-semibold">See your local rates</button>
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-1.5 rounded text-sm font-semibold">Get pre-approval</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-12">
        <h2 className="text-xl font-bold mb-4 text-gray-800 dark:text-gray-100">Amortization schedule</h2>
        <div className="flex gap-4 mb-4 border-b border-gray-200 dark:border-gray-700">
          <button className="pb-2 border-b-2 border-blue-600 font-semibold text-blue-600 dark:text-blue-400">Annual Schedule</button>
          <button className="pb-2 text-blue-600 dark:text-blue-400 hover:underline">Monthly Schedule</button>
        </div>
            ...
            <table className="w-full text-sm text-right">
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                {amortizationData.slice(0, 10).map((row, idx) => (
                  <tr key={idx} className={idx % 2 === 0 ? 'bg-gray-50 dark:bg-gray-800/50' : 'bg-white dark:bg-gray-800'}>
                    <td className="p-2 text-center text-gray-900 dark:text-gray-100">{row.year}</td>
                    <td className="p-2 text-center text-gray-600 dark:text-gray-400">{startMonth} {row.date}</td>
                    <td className="p-2 text-gray-600 dark:text-gray-400">{formatCurrency(row.interest)}</td>
                    <td className="p-2 text-gray-600 dark:text-gray-400">{formatCurrency(row.principal)}</td>
                    <td className="p-2 text-gray-900 dark:text-gray-100">{formatCurrency(row.balance)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      {/* Text Content */}
      <div className="mt-12 space-y-6 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mt-8">Mortgages</h3>
        ...
        <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mt-8">Mortgage Calculator Components</h3>
        ...
        <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mt-8">Costs Associated with Home Ownership and Mortgages</h3>
        ...
        <h4 className="font-bold text-gray-900 dark:text-gray-100">Recurring Costs</h4>
        ...
        <h4 className="font-bold text-gray-900 dark:text-gray-100 mt-4">Non-Recurring Costs</h4>
        ...
        <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mt-8">Early Repayment and Extra Payments</h3>
        ...
        <h4 className="font-bold text-gray-900 dark:text-gray-100">Early Repayment Strategies</h4>
        ...
        <h4 className="font-bold text-gray-900 dark:text-gray-100 mt-4">Reasons for early repayment</h4>
        ...
        <h4 className="font-bold text-gray-900 dark:text-gray-100 mt-4">Drawbacks of early repayment</h4>
        ...
        <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mt-8">Brief History of Mortgages in the U.S.</h3>
      ...
      <div className="lg:col-span-3 space-y-6">
        <div className="flex gap-2 mb-4">
          <input type="text" className="w-full px-2 py-1 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 outline-none text-sm" />
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded text-sm font-semibold">Search</button>
        </div>

        <div className="border border-blue-600 rounded overflow-hidden">
          <div className="bg-blue-600 text-white p-2 font-bold text-sm">
            Financial Calculators
          </div>
          <div className="bg-blue-50 dark:bg-gray-800 p-3">
            <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Mortgage</a>
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Loan</a>
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Auto Loan</a>
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Interest</a>
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Payment</a>
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Retirement</a>
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Amortization</a>
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Investment</a>
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Currency</a>
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Inflation</a>
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Finance</a>
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Mortgage Payoff</a>
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Income Tax</a>
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Compound Interest</a>
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Salary</a>
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">401K</a>
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Interest Rate</a>
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Sales Tax</a>
              <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline col-span-2">More Financial Calculators</a>
            </div>
          </div>
        </div>
