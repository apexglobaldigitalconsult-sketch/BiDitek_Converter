                ...
                <div className="space-y-3 text-sm">
                  {activeTab !== 'N' && (
                    <div className="flex items-center justify-between">
                      ...
                      <input type="number" value={n} onChange={(e) => setN(e.target.value)} className="w-32 px-2 py-1 border border-outline-variant rounded bg-surface-container-low text-primary outline-none focus:border-secondary" />
                    </div>
                  )}
                  {activeTab !== 'I/Y' && (
                    <div className="flex items-center justify-between">
                      ...
                      <div className="relative w-32">
                        <input type="number" step="0.01" value={iy} onChange={(e) => setIy(e.target.value)} className="w-full pr-6 py-1 pl-2 border border-outline-variant rounded bg-surface-container-low text-primary outline-none focus:border-secondary" />
                  ...
                  {activeTab !== 'PV' && (
                    <div className="flex items-center justify-between">
                      ...
                      <div className="relative w-32">
                        ...
                        <input type="number" value={pv} onChange={(e) => setPv(e.target.value)} className="w-full pl-6 pr-2 py-1 border border-outline-variant rounded bg-surface-container-low text-primary outline-none focus:border-secondary" />
                      </div>
                    </div>
                  )}
                  {activeTab !== 'PMT' && (
                    <div className="flex items-center justify-between">
                      ...
                      <div className="relative w-32">
                        <span className="absolute left-2 top-1/2 -translate-y-1/2 text-primary/60">$</span>
                        <input type="number" value={pmt} onChange={(e) => setPmt(e.target.value)} className="w-full pl-6 pr-2 py-1 border border-outline-variant rounded bg-surface-container-low text-primary outline-none focus:border-secondary" />
                      </div>
                    </div>
                  )}
                  {activeTab !== 'FV' && (
                    <div className="flex items-center justify-between">
                      ...
                      <div className="relative w-32">
                        <span className="absolute left-2 top-1/2 -translate-y-1/2 text-primary/60">$</span>
                        <input type="number" value={fv} onChange={(e) => setFv(e.target.value)} className="w-full pl-6 pr-2 py-1 border border-outline-variant rounded bg-surface-container-low text-primary outline-none focus:border-secondary" />
                      </div>
                    </div>
                  )}
