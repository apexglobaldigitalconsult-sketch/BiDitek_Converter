  ...
  return (
    <div className="px-6 lg:px-16 py-12 lg:py-20">
      ...
      <nav className="flex items-center gap-3 text-[10px] font-label font-black uppercase tracking-[0.2em] text-primary/30 mb-12">
        ...
        <ChevronRight className="w-3 h-3" />
        <span className="text-primary font-black">BMI Calculator</span>
      </nav>

      <div className="mb-16">
        <h1 className="font-headline text-6xl lg:text-8xl font-extrabold tracking-tighter text-primary leading-[0.9]">BMI Calculator</h1>
        <p className="text-primary/50 mt-6 max-w-2xl font-body text-lg leading-relaxed">
          Calculate your Body Mass Index (BMI) using high-precision metric and imperial inputs for an editorial-grade health assessment.
        </p>
      </div>

      <div className="grid grid-cols-1 xl:grid-cols-12 gap-12 items-start">
        {/* Input Card */}
        <div className="xl:col-span-7 bg-surface-container-low rounded-[1px] p-10 lg:p-16 space-y-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                ...
                {['male', 'female'].map((g) => (
                  <button
                    ...
                    className={cn(
                      ...
                      gender === g ? "bg-primary text-white shadow-xl" : "bg-white text-primary/30 hover:text-primary"
                    )}
                  >
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-[1px] flex items-center px-8 focus-within:ring-4 ring-secondary/5 transition-all">
                <input 
                  type="number" 
                  value={age}
                  onChange={(e) => setAge(Number(e.target.value))}
                  className="w-full bg-transparent border-none py-5 text-2xl font-headline font-bold focus:ring-0"
                />
            ...
            <div className="flex justify-between items-end px-4">
              ...
              <div className="flex bg-surface-container-highest rounded-[1px] p-1 text-[10px] font-black">
                <button 
                  ...
                  className={cn("px-4 py-1.5 rounded-[1px] transition-all", unit === 'metric' ? "bg-white shadow-sm" : "text-primary/30")}
                >CM</button>
                <button 
                  onClick={() => setUnit('imperial')}
                  className={cn("px-4 py-1.5 rounded-[1px] transition-all", unit === 'imperial' ? "bg-white shadow-sm" : "text-primary/30")}
                >FT</button>
              </div>
            </div>
            <div className="bg-white rounded-[1px] p-8 flex flex-col md:flex-row md:items-center justify-between gap-8 editorial-shadow">
              <div className="flex items-baseline gap-4">
                <input 
                  type="number" 
                  value={height}
                  onChange={(e) => setHeight(Number(e.target.value))}
                  className="w-32 bg-transparent border-none p-0 text-6xl font-headline font-bold focus:ring-0"
                />
          ...
          <div className="space-y-8">
            <div className="flex justify-between items-end px-4">
              ...
              <div className="flex bg-surface-container-highest rounded-[1px] p-1 text-[10px] font-black">
                <button className="px-4 py-1.5 bg-white rounded-[1px] shadow-sm">KG</button>
          ...
          <button className="w-full bg-secondary text-white py-8 rounded-[1px] font-headline font-bold text-2xl hover:bg-primary transition-all shadow-2xl shadow-secondary/20">
            CALCULATE BMI
          </button>
        </div>
        ...
        <div className="xl:col-span-5 space-y-8">
          <div className="bg-white rounded-[1px] p-12 lg:p-16 editorial-shadow text-center">
            ...
            <div className="space-y-6">
              ...
              <div className="h-4 w-full rounded-full bg-gradient-to-r from-blue-400 via-green-400 to-red-400 relative">
                <motion.div 
                  ...
                  className="absolute top-1/2 -translate-y-1/2 w-2 h-8 bg-primary rounded-full border-4 border-white shadow-lg"
                />
              </div>
            </div>

            <div className="mt-16 grid grid-cols-2 gap-6">
              <div className="bg-surface-container-low p-8 rounded-[1px]">
          ...
          <details className="group bg-surface-container-low rounded-[1px] overflow-hidden transition-all">
            <summary className="flex justify-between items-center p-8 cursor-pointer list-none font-headline font-bold text-lg uppercase tracking-tight">
              Technical Formula
              <ChevronDown className="w-6 h-6 group-open:rotate-180 transition-transform" />
            </summary>
            <div className="px-10 pb-10 space-y-8">
              <div className="p-10 bg-white rounded-[1px] text-center editorial-shadow">
