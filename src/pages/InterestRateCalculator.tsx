        ...
        <div className="lg:col-span-9 space-y-8">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="relative w-32">
                      ...
                      <input type="number" value={loanAmount} onChange={(e) => setLoanAmount(e.target.value)} className="w-full pl-6 pr-2 py-1 border border-outline-variant rounded bg-surface-container-low text-primary outline-none focus:border-secondary" />
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2 w-32">
                      <div className="relative w-1/2">
                        <input type="number" value={loanTermYears} onChange={(e) => setLoanTermYears(e.target.value)} className="w-full pr-6 pl-2 py-1 border border-outline-variant rounded bg-surface-container-low text-primary outline-none focus:border-secondary" />
                        <span className="absolute right-1 top-1/2 -translate-y-1/2 text-primary/50 text-[10px]">years</span>
                      </div>
                      <div className="relative w-1/2">
                        <input type="number" value={loanTermMonths} onChange={(e) => setLoanTermMonths(e.target.value)} className="w-full pr-8 pl-2 py-1 border border-outline-variant rounded bg-surface-container-low text-primary outline-none focus:border-secondary" />
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="relative w-32">
                      <span className="absolute left-2 top-1/2 -translate-y-1/2 text-primary/60">$</span>
                      <input type="number" value={monthlyPayment} onChange={(e) => setMonthlyPayment(e.target.value)} className="w-full pl-6 pr-2 py-1 border border-outline-variant rounded bg-surface-container-low text-primary outline-none focus:border-secondary" />
                    </div>
                  </div>
          ...
          <div className="mt-8">
            ...
            <div className="flex flex-wrap gap-2">
              <button className="bg-secondary hover:bg-secondary/80 text-white px-4 py-1.5 rounded text-sm shadow-sm">APR Calculator</button>
              ...
              <button className="bg-secondary hover:bg-secondary/80 text-white px-4 py-1.5 rounded text-sm shadow-sm">Compound Interest Calculator</button>
            </div>
          </div>
